...
IN=/home/user/smithsonian/images/nasm
OUT=/home/user/smithsonian/images/nasm_512
...
| parallel -0 -j "$J" \
  vipsthumbnail {} --size '512x512>' --rotate -o "$OUT/%s.jpg[Q=90,optimize_coding,keep=none]"
